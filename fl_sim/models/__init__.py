...
from .gan import ResNetGAN, ConditionalResNetGAN, PathwaysResNetGAN, LinearPathwaysResNetGAN
...
__all__ = [
    ...
    'log_reg',
    'ResNetGAN', 'ConditionalResNetGAN', 'PathwaysResNetGAN', 'LinearPathwaysResNetGAN',
    'BetaVAE',
    ]
